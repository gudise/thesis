...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set available [ create_bd_port -dir I available ]
  set data [ create_bd_port -dir I data ]
  set stored [ create_bd_port -dir O stored ]

  # Create instance: ASYNC_COMM_RX_0, and set properties
  set block_name ASYNC_COMM_RX
  set block_cell_name ASYNC_COMM_RX_0
  if { [catch {set ASYNC_COMM_RX_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $ASYNC_COMM_RX_0 eq "" } {
  ...
  connect_bd_net -net ASYNC_COMM_RX_0_buffer_out [get_bd_pins ASYNC_COMM_RX_0/buffer_r] [get_bd_pins axi_gpio_data/gpio_io_i]
  connect_bd_net -net ASYNC_COMM_RX_0_done [get_bd_pins ASYNC_COMM_RX_0/done] [get_bd_pins axi_gpio_ctrl/gpio_io_i]
  connect_bd_net -net ASYNC_COMM_RX_0_stored [get_bd_ports stored] [get_bd_pins ASYNC_COMM_RX_0/stored]
  connect_bd_net -net available_0_1 [get_bd_ports available] [get_bd_pins ASYNC_COMM_RX_0/available]
  connect_bd_net -net axi_gpio_ctrl_gpio2_io_o [get_bd_pins ASYNC_COMM_RX_0/reset] [get_bd_pins axi_gpio_ctrl/gpio2_io_o]
  connect_bd_net -net data_0_1 [get_bd_ports data] [get_bd_pins ASYNC_COMM_RX_0/data]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins ASYNC_COMM_RX_0/clock] [get_bd_pins axi_gpio_ctrl/s_axi_aclk] [get_bd_pins axi_gpio_data/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
