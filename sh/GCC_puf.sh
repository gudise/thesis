...
gcc "${1}" -o "${2}" -g -lm -lgsl -lgslcblas -lgmp -lmpfr -fopenmp -I"$REPO_puf/c/include" -I"$GSL_DIR/include" -I"$GMP_DIR/include" -I"$MPFR_DIR/include" -L"$GSL_DIR/lib" -L"$GMP_DIR/lib" -L"$MPFR_DIR/lib"
