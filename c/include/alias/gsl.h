/*
	Los archivo comentados NO están disponibles en la versión instalada con el gestor de paquetes 'apt'.
	Descomentarlas si se instala la biblioteca gsl a partir del código fuente */
